...
const doAsyncThing = (input, callback) => {
  setTimeout(function() {
    callback(null, input);
  }, 100);
};
...
const requestUrlWithError = (url, callback) => {
  setTimeout(function() {
...
const postToUrl = (url, data, callback) => {
  setTimeout(function() {
    callback(null, md5(url + data))
  }, 100);
};

const process1 = (input, callback) => {
  setTimeout(function() {
    callback(null, input.split('').join('_'))
  }, 100);
};

const process2 = (input, callback) => {
  setTimeout(function() {
    callback(null, input.split('').join('-'))
  }, 100);
};

const process3 = (input, callback) => {
  setTimeout(function() {
    callback(null, input.slice(0, 10))
  }, 100);
};

const process4 = (input, callback) => {
  setTimeout(function() {
